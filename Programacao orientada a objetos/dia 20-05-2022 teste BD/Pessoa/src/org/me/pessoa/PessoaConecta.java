...
alteraPessoa = connection.prepareStatement( "UPDATE EMPRESA.TABAGENDA SET NOME = ?, SOBRENOME = ?, EMAIL = ?, TELEFONE = ?" + "WHERE ID = ?");

excluiPessoa = connection.prepareStatement(
"DELETE FROM EMPRESA.TABAGENDA " + "WHERE ID = ?");
